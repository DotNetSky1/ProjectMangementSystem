    ...
    public partial class WebForm7 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                foreach (DataRow row in data.Rows)
                {
                    ...
                    lblViewProject.Text = lblViewProject.Text + "<tr><td>" + Project_Title + "</td><td>" + StartDate.ToShortDateString() + "</td><td>" + EndDate.ToShortDateString() + "</td><td>" + TotalDays + "</td><td>" + Project_Description + "</td><td>" + CurrentStatus + "</td><td>" + P_Complete + "</td><td>" + Mem_id + "</td><td><a href='ViewTasks.aspx?ProjectID=" + Project_id + "'><span class='glyphicon glyphicon-search'></span></a> </td> <td><a href='ViewProjects.aspx?ProjectID=" + pID + "'><span class='glyphicon glyphicon-trash text-danger'></span></a></td> </tr>";
